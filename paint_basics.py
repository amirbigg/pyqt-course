...
from PyQt6.QtGui import QPainter, QPainterPath, QColor, QBrush, QPen, QFont, QPolygon, QLinearGradient
...
class MainWindow(QMainWindow):
    ...
    def initializeUI(self):
        ...
        self.black = '#000000'
        self.blue = Qt.GlobalColor.blue
        self.green = Qt.GlobalColor.green
        self.purple = Qt.GlobalColor.magenta
        self.red = Qt.GlobalColor.red
        self.orange = Qt.GlobalColor.yellow
    ...
    def drawText(self, painter):
        ...
        painter.setPen(pen)
        painter.drawText(420, 110, "Hello user..!")
    ...
    def drawRoundedRects(self, painter):
        ...
        painter.setBrush(brush)
        painter.drawRoundedRect(rect_1, 20, 20)

    def drawCurves(self, painter):
        pen = QPen(QColor(self.black), 3)
    ...
    def drawCircle(self, painter):
        pen = QPen(QColor(self.black), 2, Qt.PenStyle.SolidLine)
        brush = QBrush(Qt.GlobalColor.darkMagenta, Qt.BrushStyle.Dense2Pattern)

        painter.setPen(pen)
        painter.setBrush(brush)
        painter.drawEllipse(QPoint(300, 500), 60, 60)
