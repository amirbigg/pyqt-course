import os, sys, time
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QProgressBar, QLineEdit, QPushButton,
                             QTextEdit, QComboBox, QFileDialog, QGridLayout)
...
class Worker(QThread):
    update_value_signal = pyqtSignal(int) # update progress bar
    update_text_edit_signal = pyqtSignal(str, str) # update contents of the QTextEdit
    clear_text_edit_signal = pyqtSignal() # clear the text edit widget if user clicks Stop
...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        dir_label = QLabel("""<p>User Button to Choose Directory and Change File Names: </p>""")
        ...
        self.change_name_edit.setToolTip("""<p>Files will be appended with numerical values. For example: filename<b>01</b>.jpg</p>""")
    ...
    def chooseDirectory(self):
        ...
        self.directory = file_dialog.getExistingDirectory(self, "Open Directory", "", QFileDialog.Option.ShowDirsOnly)
    ...
    def updateTextEdit(self, old_text, new_text):
        self.display_files_tedit.append(f"[INFO] {old_text} changed to {new_text}.")
